...
file_score = open('/home/users/ubaldi/TESI_PA/result_CV/score.txt', 'w')
file_score.write(score)
file_score.close()


file_best_params = open('/home/users/ubaldi/TESI_PA/result_CV/best_params.txt', 'w')
file_best_params.write(grid.best_params_)

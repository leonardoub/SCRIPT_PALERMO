...
for sd in np.arange(0,31):
    ...
    #score
    score = svc.score(X_test_scaled_pca, y_test)

    total_score.append(score)

file_score = open('/home/users/ubaldi/TESI_PA/result_CV/score_test_stability_svm.txt', 'w')
...
file_score = open('/home/users/ubaldi/TESI_PA/result_CV/score_test_stability_svm_seed_TTS_fissato.txt', 'w')

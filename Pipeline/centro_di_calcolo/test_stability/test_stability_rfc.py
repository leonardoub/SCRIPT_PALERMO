...
for sd in np.arange(0,31):
    ...
    #score
    score = rfc.score(X_test_scaled_pca, y_test)

    total_score.append(score)

file_score = open('/home/users/ubaldi/TESI_PA/result_CV/score_test_stability_rfc_seed_in_alto_fissato.txt', 'w')
...
file_score = open('/home/users/ubaldi/TESI_PA/result_CV/score_test_stability_rfc_seed_tutti_fissati.txt', 'w')

...
file_score = open('/home/users/ubaldi/TESI_PA/result_CV/score_RS_SVM.txt', 'w')
file_score.write(f'{score}')
file_score.close()


file_best_params = open('/home/users/ubaldi/TESI_PA/result_CV/best_params_RS_SVM.txt', 'w')

...
for i in range(1,11):
    ...
    steps = [('scaler', StandardScaler()), ('red_dim', PCA()), ('clf', SVC(kernel='sigmoid', random_state=i*1000))]
    ...
    file_best_params = open(f'/home/users/ubaldi/TESI_PA/result_CV/GS_sigmoid_svm_stability/best_params_rs{i*1000}_acc_{score}.txt', 'w')
